...
var BuildId = "QHJCRJ1m5W__uMwErWRpV";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "QHJCRJ1m5W__uMwErWRpV", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "wnkMaO2FkZIk0vLit1xRFOVZElNmhrZHQleLP6Wcutc=", "__NEXT_PREVIEW_MODE_ID": "c143180b365a818f557f824111b11f64", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "129d5ea1235c885ef8c327fe2e884ce883b11ea7b51102ca8f86ec730fdbe8b1", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "43d94e172b8cf783002f6b8d2546652cdfb7898f941e0750ac1f2419b9870180" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/test-users/route": "/api/test-users", "/api/reservas/generate-random/route": "/api/reservas/generate-random", "/api/reservas/cleanup-desactivados/route": "/api/reservas/cleanup-desactivados", "/api/usuarios/activate-all/route": "/api/usuarios/activate-all", "/api/auth/login/route": "/api/auth/login", "/api/clases/route": "/api/clases", "/api/test/route": "/api/test", "/api/test-post/route": "/api/test-post", "/api/auth/logout/route": "/api/auth/logout", "/api/export/route": "/api/export", "/api/reservas/route": "/api/reservas", "/api/usuarios/route": "/api/usuarios", "/calendario/page": "/calendario", "/login/page": "/login", "/clases/page": "/clases", "/page": "/", "/reservas/page": "/reservas", "/usuarios/page": "/usuarios" };
