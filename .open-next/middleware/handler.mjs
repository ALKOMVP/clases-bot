...
var BuildId = "salN7Ttnag13oHQ954WW1";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "salN7Ttnag13oHQ954WW1", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "B1T1rL96YETjywgSBbT0NqDPLbMZ4igk5UdqFkfezoc=", "__NEXT_PREVIEW_MODE_ID": "a8c4492640ca06683bb865b8469c8cdf", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "df434c92283cb34f8654f272c41d5113d81bc8a724ed6cc4b65b374951fed572", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "1c638c8126569cc6a674788d907b00eaee3a168c56d7cd52e5a6c57c38014949" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/cancelaciones/route": "/api/cancelaciones", "/_not-found/page": "/_not-found", "/api/clases/desactivar-fecha/route": "/api/clases/desactivar-fecha", "/api/reservas/cleanup-desactivados/route": "/api/reservas/cleanup-desactivados", "/api/reservas/diagnostico-clase/route": "/api/reservas/diagnostico-clase", "/api/reservas/generate-random/route": "/api/reservas/generate-random", "/api/reservas/temporal/route": "/api/reservas/temporal", "/api/reservas/lista-espera-counts/route": "/api/reservas/lista-espera-counts", "/api/reservas/lista-espera/route": "/api/reservas/lista-espera", "/api/test-users/route": "/api/test-users", "/api/reservas/temporales/route": "/api/reservas/temporales", "/api/usuarios/activate-all/route": "/api/usuarios/activate-all", "/api/whatsapp/send-template/route": "/api/whatsapp/send-template", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/login/route": "/api/auth/login", "/api/export/route": "/api/export", "/api/test-post/route": "/api/test-post", "/api/clases/route": "/api/clases", "/api/test/route": "/api/test", "/api/usuarios/route": "/api/usuarios", "/api/reservas/route": "/api/reservas", "/api/whatsapp/webhook/route": "/api/whatsapp/webhook", "/calendario/page": "/calendario", "/clases/page": "/clases", "/cancelaciones/page": "/cancelaciones", "/asignaciones-temporales/page": "/asignaciones-temporales", "/usuarios/page": "/usuarios", "/reservas/page": "/reservas", "/page": "/", "/login/page": "/login" };
